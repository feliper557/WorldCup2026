          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Box className="fade-up" sx={{ mb: 2 }}>
              <Chip
                ...
                label="Premios Exclusivos · Gana Ahora"
                size="small"
                sx={{
            ...
            <Box className="fade-up" sx={{ mb: 2 }}>
              <Typography
                ...
                sx={{
                  ...
                  lineHeight: 1.1,
                  mb: 0.5,
                  background: `linear-gradient(135deg, ${theme.palette.text.primary} 0%, ${theme.palette.secondary.main} 60%, ${theme.palette.warning.main} 100%)`,
                  backgroundClip: 'text',
            ...
            >
              Participa en nuestras rifas exclusivas y gana increíbles premios.
              Cada predicción correcta te acerca más a los premios 🎁🏆
            </Typography>
